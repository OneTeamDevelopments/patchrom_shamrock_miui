...
# All apks from MIUI
local-miui-removed-apps := GameCenter FM Mipay MiuiCompass MiuiSuperMarket XiaomiVip MiGameCenterSDKService SogouInput SystemAdSolution VoiceAssist YellowPage
